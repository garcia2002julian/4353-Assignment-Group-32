...
describe("Testing /update/:username", () => {
  test("It should response the PUT method", async () => {
    ...
    // Act
    const res = await request(app).put(`/update/${userToUpdate.username}`).send(userToUpdate);
...
describe("Testing /submitQuota", () => {
  ...
  test("It should response the POST method", async () => {
    ...
    // Act
    const res = await request(app).post("/submitQuota").send(quotaToBeSubmitted);
...
describe("Testing /updateStatus/:username", () => {
  ...
  test("It should response the PUT method", async () => {
    ...
    // Act
    const res = await request(app).put(`/updateStatus/${userToUpdate.username}`).send(userToUpdate);
